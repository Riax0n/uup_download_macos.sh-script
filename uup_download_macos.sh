#!/bin/bash
#Generated on 2022-09-19 07:50:31 GMT
...
aria2c --no-conf --log-level=info --log="aria2_download.log" -o"$tempScript" --allow-overwrite=true --auto-file-renaming=false "https://uupdump.net/get.php?id=7811e991-621e-4b0c-a066-ee0d4b53eacf&pack=en-us&edition=core&aria2=2"
if [ $? != 0 ]; then
